abstract class ApiNames {
  ...
  // static propertyInfo(userId, propertyId) =>
  //     "landlords/$userId/properties/$propertyId";
  ...
  // static const PAYMENT_METHOD =
  //     "payment_methods?list=payment_method_name,payment_method_display_name";
  // static const UNIT_TYPES =
  //     "unit_types?list=unit_type_name,unit_type_display_name";
  // static profileEditing(userId) => "landlord_profile/$userId";
  // static singleInvoice(userId, invoiceId) =>
  //     "landlords/$userId/invoices/$invoiceId";
