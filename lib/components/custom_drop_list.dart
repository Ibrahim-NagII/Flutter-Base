...
class _CustomDropListState extends State<CustomDropList> {
  ...
  late DropListModel dropdownValue = DropListModel(id: 0 ,
  name: "Select One");
    ...
    return Container(
      ...
      child: DropdownButton<DropListModel>(
        icon: Padding(
          ...
          child: const Icon(Icons.arrow_drop_down , color: Styles.HINT,),
        ),
        iconSize: 24,
        elevation: 16,
        hint: Padding(
          ...
          child: Row(
            children: [
              Text(
                dropdownValue.name!,
                style: TextStyle(fontSize: 13.0 ,fontWeight: FontWeight.w500, color: dropdownValue.id != 0 ? Styles.HEADER :Styles.HINT),
                maxLines: 2,
